export const BUFF_IDS = ['split_arrow', 'power_shot', 'swift_shot', 'rapid_fire', 'piercing_arrow', 'lightning_targets', 'lightning_damage', 'lightning_range', 'vitality', 'windstep', 'barkskin'] as const;
...
export const BUFF_CATALOG: Record<BuffId, BuffDefinition> = {
  ...
  lightning_damage: { id: 'lightning_damage', gateLabel: '電擊傷害 +2', pickupLabel: '電能 +1', isOffensive: true },
