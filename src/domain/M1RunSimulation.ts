...
export class M1RunSimulation {
  ...
  private spawnBoss(): void { const hp = getChapterDefinition(this.chapterId).bossHp; this.enemies.length = 0; this.boss = { hp, maxHp: hp, phase: 1, telegraphSeconds: 0.8, telegraphText: '苔冠守衛被靜滯困住了。', attackCooldownSeconds: 2.5, isDefeated: false }; }
