...
export class M1RunSimulation {
  ...
  private spawnEnemies(): void { if (this.distanceMeters >= 15 && !this.hasEnemy('melee-1')) this.enemies.push({ id: 'melee-1', kind: 'melee', x: -2, z: 30, hp: 8, attackCooldownSeconds: 0, telegraphSeconds: 0, deathSeconds: 0 }, { id: 'melee-2', kind: 'melee', x: 0, z: 34, hp: 8, attackCooldownSeconds: 0, telegraphSeconds: 0, deathSeconds: 0 }, { id: 'melee-3', kind: 'melee', x: 2, z: 38, hp: 8, attackCooldownSeconds: 0, telegraphSeconds: 0, deathSeconds: 0 }); if (this.distanceMeters >= 35 && !this.hasEnemy('ranged-1')) this.enemies.push({ id: 'ranged-1', kind: 'ranged', x: 0, z: 38, hp: 12, attackCooldownSeconds: 2, telegraphSeconds: 0, deathSeconds: 0 }); }
