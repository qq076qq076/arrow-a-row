...
export const CANNON_DAMAGE_BONUS = 0.25;
...
export class M1RunSimulation {
  ...
  private fireAtNearestTarget(): void {
    ...
    if (this.player.cannonUnlocked && this.cannonCooldownSeconds <= 0) {
      ...
      this.arrows.push({ id: this.nextArrowId++, weapon: 'cannon', x: this.player.x, z: 1, vx: 0, damage: this.player.cannonDamage, blastRadius: CANNON_BLAST_RADIUS, piercesRemaining: 0, hitEnemyIds: [], hitBoss: false });
    }
  }
