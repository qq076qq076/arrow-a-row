...
export const DEFAULT_PROFILE: Profile = { gold: 0, healthLevel: 0, damageLevel: 0, fireRateLevel: 0, arrowSpeedLevel: 0, pierceLevel: 0, movementLevel: 0, unlockedChapterIndex: 1, achievementIds: [] };
