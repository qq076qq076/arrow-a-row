...
| 5 | 工程師 | CH01 端到端玩法、存檔與商店 | Completed | [M2-ENG-001](M2-ENG-001-第一章端到端實作.md)、[M2-ENG-002](M2-ENG-002-Checkpoint恢復.md) | `工程(M2)：完成第一章垂直切片玩法`、`工程(M2)：完成第一章Checkpoint恢復` |
| 6 | 測試人員 | M2 垂直切片回歸 | Ready | — | — |
