...
| --- | --- | --- | --- | --- | --- |
| Rock 07 | https://polyhaven.com/a/rock_07 | Jenelle van Heerden | `public/assets/polyhaven/rock_07/rock_07.gltf`、1K JPG 貼圖與 BIN | CH01 晨線草原道路兩側的岩石景物；全章共用的玩家、小怪、Boss 與 Buff 模型基線 | [CC0 1.0](https://polyhaven.com/license)；可自由使用、修改與商用，不要求署名。 |
